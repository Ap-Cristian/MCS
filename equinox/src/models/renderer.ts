...
import { MACGridDrawable } from "../drawables/mcsGridDrawable";
import { SphereDrawable } from "../drawables/sphere";
...
export class Renderer {
  ...
  private createDrawablesFromSceneObjects() {
    ...
    const grid = new MACGridDrawable(
      this.cameraProjectionArray,
      activeSceneGrid,
      "main_grid",
    );

    const sphere = new SphereDrawable(
      this.cameraProjectionArray,
      new McsObject(),
      "test_sphere",
    );
